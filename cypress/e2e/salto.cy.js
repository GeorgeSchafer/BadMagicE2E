...
describe('Login to BadMagic', () => {
  before('Open Login Page, dismiss cookies banner', () => {
    cy.visit(login.url)
  ...
  it('01 Create Profile', ()=> {
    ...
    cy.get('body > div > div > div.w-full.flex-grow.grid.divide-x.grid-cols-4 > div.p-4.col-span-3.overflow-y-scroll > div.overflow-hidden.p-4.border.rounded.overflow-x-hidden.mb-4.bg-gray-200.border-gray-400 > div.flex.py-2 > div.flex.flex-col.flex-grow.mr-4 > div:nth-child(2) > div:nth-child(5) > div > div.flex.flex-grow > div > select').select(personas.salto.guests.permanent.credential_type)
